		...
		<div class="col-sm-7">
          ...
          <br>
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-outline-primary rate @if(isset($rt) && $rt == 1) active @endif">
                ...
                <label class="btn btn-outline-secondary rate @if(isset($rt) && $rt == 2) active @endif">
                ...
                <label class="btn btn-outline-danger rate @if(isset($rt) && $rt == 3) active @endif">
                ...
                <label class="btn btn-outline-warning rate @if(isset($rt) && $rt == 4) active @endif">
                ...
                <label class="btn btn-outline-info rate @if(isset($rt) && $rt == 5) active @endif">
